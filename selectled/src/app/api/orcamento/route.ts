...
<body style="font-family: system-ui, sans-serif; background: #0A0A0A; color: #F5F5F7; padding: 32px; margin: 0;">
  <table width="600" style="margin: 0 auto; background: #141414; border: 1px solid #2C2C2E; border-radius: 16px; overflow: hidden;">
    <tr>
      <td style="background: #FF3B30; padding: 24px 32px;">
    ...
    <tr>
      <td style="padding: 32px;">
        <h2 style="color: #FF3B30; font-size: 14px; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 16px;">Dados do contato</h2>
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr><td style="padding: 8px 0; color: #6E6E73; font-size: 14px;">E-mail</td><td style="color: #F5F5F7; font-size: 14px;"><a href="mailto:${email}" style="color: #FF3B30;">${email}</a></td></tr>
        ...
        <h2 style="color: #FF3B30; font-size: 14px; text-transform: uppercase; letter-spacing: 0.08em; margin: 0 0 16px;">Dados do evento</h2>
        <table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
      <td style="padding: 32px;">
        <p style="color: #A1A1A6; font-size: 16px; line-height: 1.6; margin: 0 0 24px;">
          Olá, <strong style="color: white;">${name}</strong>! Recebemos sua solicitação e retornaremos em até <strong style="color: #FF3B30;">2 horas úteis</strong> com uma proposta personalizada.
        </p>
