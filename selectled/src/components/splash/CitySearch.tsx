...
export function CitySearch({ onFocus }: CitySearchProps) {
  ...
  return (
    <div ref={ref} className="relative w-full max-w-xl mx-auto">
      <div className="flex items-center gap-3 bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.12)] rounded-full px-5 py-4 focus-within:border-[rgba(255,59,48,0.5)] focus-within:bg-[rgba(255,59,48,0.04)] focus-within:shadow-[0_0_0_4px_rgba(255,59,48,0.08)] transition-all duration-200">
        ...
        <div className="absolute top-full mt-2 left-0 right-0 bg-[#111] border border-[#2C2C2E] rounded-2xl shadow-2xl shadow-black/60 overflow-hidden z-50">
          {results.map((city) => (
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 hover:bg-[rgba(255,59,48,0.06)] transition-colors text-left border-b border-[#1C1C1E] last:border-0"
            >
