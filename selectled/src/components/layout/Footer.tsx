            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  ...
                  className="text-sm text-[#FF0000] hover:text-[#FF6B60] transition-colors font-medium"
                >
                  {t.buyPanel}
                </Link>
              </li>
          ...
          <div>
            ...
            {city && (
              <div className="space-y-3">
                ...
                <div className="flex gap-2.5">
                  <Mail size={14} className="text-[#FF0000] mt-0.5 shrink-0" />
                  <a href={`mailto:${city.rep.email}`} className="text-sm text-[#6E6E73] hover:text-[#A1A1A6] transition-colors">
                    {city.rep.email}
                  </a>
                </div>
                <div className="flex gap-2.5">
                  <Phone size={14} className="text-[#FF0000] mt-0.5 shrink-0" />
                  <a
