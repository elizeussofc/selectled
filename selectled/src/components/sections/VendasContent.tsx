      ...
      <main className="bg-[#0A0A0A]">
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden">
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_40%,rgba(239,68,68,0.08)_0%,transparent_70%)]" />
            <div
          ...
          <Container className="relative z-10 py-40">
            <p className="text-xs font-semibold uppercase tracking-widest text-[#EF4444] mb-6">
            ...
            >
              {v.h1Part1}<br />
              <span className="text-[#EF4444]">{v.h1Part2}</span>
            </h1>
        ...
        <div className="sticky top-16 z-30 bg-[#0A0A0A]/95 backdrop-blur-sm border-b border-[#2C2C2E]">
          <Container>
            <div className="flex items-center gap-1 overflow-x-auto py-3 scrollbar-hide">
              ...
              <a href="#financiamento" className="flex-shrink-0 px-4 py-2 rounded-lg text-sm font-medium text-[#EF4444] hover:bg-[rgba(239,68,68,0.08)] transition-colors whitespace-nowrap">
                {v.simulateFinancing}
              </a>
            </div>
          </Container>
              ...
              {v.benefits.map((b, i) => {
                ...
                return (
                  <div key={b.title} className="flex flex-col items-center text-center p-6 bg-[#141414] border border-[#2C2C2E] rounded-2xl">
                    <div className="p-3 bg-[rgba(239,68,68,0.10)] rounded-2xl mb-4">
          ...
          <Container>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {products.map((product) => (
                <div
                  key={product.slug}
                  className="group bg-[#141414] border border-[#2C2C2E] rounded-2xl overflow-hidden hover:border-[rgba(239,68,68,0.4)] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-red-900/20"
                >
                  <div className="relative h-48 bg-gradient-to-br from-[#1A1A1A] to-[#0D0D0D] flex items-center justify-center">
                    <div className="text-center">
                      <div className="text-3xl font-black text-[rgba(239,68,68,0.15)] mb-1" style={{ fontFamily: "var(--font-display)" }}>
                        {product.shortName}
                      </div>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xs font-semibold text-[#EF4444] flex items-center gap-1 hover:gap-2 transition-all"
                      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {SALES_CASES.map((c) => (
                <div key={c.client} className="bg-[#141414] border border-[#2C2C2E] rounded-2xl p-6">
                  <span className="text-xs font-semibold text-[#EF4444] uppercase tracking-wide">{c.type}</span>
