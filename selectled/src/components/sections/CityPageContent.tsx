      ...
      <main className="bg-[#0A0A0A]">
        ...
        <section className="relative min-h-[90vh] flex items-center overflow-hidden">
          <div className="absolute inset-0">
            ...
            <div className="absolute -top-20 right-0 w-[1000px] h-[1000px] rounded-full" style={{ background: "radial-gradient(circle at 80% 20%, rgba(255,59,48,0.1) 0%, transparent 55%)" }} />
            <div className="absolute top-1/2 left-1/2 w-[800px] h-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full" style={{ background: "radial-gradient(circle, rgba(255,59,48,0.04) 0%, transparent 60%)" }} />
            ...
            <div className="grid lg:grid-cols-[1fr_440px] xl:grid-cols-[1fr_480px] gap-10 xl:gap-14 items-center">
              <div className="stagger">
                ...
                <h1 className="font-black text-white mb-8 leading-[0.88] tracking-tight" style={{ fontFamily: "var(--font-display)", letterSpacing: "-0.04em", fontSize: "clamp(2.4rem, 5vw, 5rem)" }}>
                  {t.hero.h1Line1}<br />
                  {t.hero.h1Line2}{" "}
                  <span className="text-[#FF3B30]" style={{ textShadow: "0 0 80px rgba(255,59,48,0.4), 0 0 160px rgba(255,59,48,0.15)" }}>
                    {city.name}
                  </span>
                </h1>
                ...
                <div className="mb-8" style={{ transformOrigin: "center bottom", animation: "float 4s ease-in-out infinite" }}>
                  ...
                  <img src="/images/foto-capa-1.png" alt="Painel de LED Select LED" style={{ width: "100%", maxWidth: 460, height: "auto", filter: "drop-shadow(0 18px 56px rgba(255,59,48,0.28)) drop-shadow(0 4px 16px rgba(0,0,0,0.6))" }} />
                </div>
              ...
              <div className="hidden lg:flex items-center justify-center animate-fade-in" style={{ animationDelay: "0.35s" }}>
                <div className="relative w-full max-w-[480px]">
                  <div className="absolute inset-8 rounded-3xl blur-3xl" style={{ background: "radial-gradient(ellipse, rgba(255,59,48,0.18) 0%, transparent 70%)" }} />
                  ...
                  <div className="absolute -top-3 -right-3 bg-[#161616] border border-[rgba(255,59,48,0.35)] rounded-xl px-3.5 py-2.5 shadow-xl">
                    <p className="text-sm font-black text-[#FF3B30]" style={{ fontFamily: "var(--font-display)" }}>+5.000</p>
        ...
        <Section>
          <Container>
            <div className="text-center mb-10">
              <p className="text-xs uppercase tracking-widest text-[#FF3B30] font-semibold mb-2">{t.sections.repBadge}</p>
        ...
        <Section className="bg-[#0D0D0D]">
          <Container>
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-widest text-[#FF3B30] font-semibold mb-2">{t.sections.servicesBadge}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href={`/${cidade}/paineis-led`} className="group md:col-span-2 relative bg-[#141414] border border-[#2C2C2E] rounded-2xl p-6 hover:border-[rgba(255,59,48,0.4)] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-red-900/20">
        ...
        <section className="bg-gradient-to-r from-[#0A0A0A] to-[#1A0A09] border-y border-[#2C2C2E] py-16">
          <Container>
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-[#FF3B30] mb-2">{t.sections.salesBadge}</p>
          ...
          <Section className="bg-[#0D0D0D]">
            <Container>
              <div className="flex items-end justify-between mb-10">
                <div>
                  <p className="text-xs uppercase tracking-widest text-[#FF3B30] font-semibold mb-2">{t.sections.portfolioBadge}</p>
                  <h2 className="text-3xl md:text-4xl font-bold text-white" style={{ fontFamily: "var(--font-display)" }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {cases.map((c, idx) => (
                  <div key={c.id} className="group bg-[#111] border border-[#1C1C1E] rounded-2xl overflow-hidden hover:border-[rgba(255,59,48,0.3)] transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div className="p-5">
                      <span className="text-xs font-semibold uppercase tracking-wide text-[#FF3B30]">{c.category}</span>
        ...
        <Section>
          <Container>
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-widest text-[#FF3B30] font-semibold mb-2">{t.sections.testimonialsBadge}</p>
              <h2 className="text-3xl md:text-4xl font-bold text-white" style={{ fontFamily: "var(--font-display)" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {testimonials.map((tm, i) => (
                <div key={i} className="relative bg-[#141414] border border-[#2C2C2E] rounded-2xl p-6 overflow-hidden">
                  <div className="absolute -top-1 right-4 text-8xl font-black leading-none select-none pointer-events-none" style={{ color: "rgba(255,59,48,0.07)", fontFamily: "var(--font-display)" }}>&ldquo;</div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-[rgba(255,59,48,0.1)] border border-[rgba(255,59,48,0.15)] flex items-center justify-center text-xs font-bold text-[#FF3B30] shrink-0" style={{ fontFamily: "var(--font-display)" }}>
            ...
            <div className="text-center max-w-2xl mx-auto">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-5" style={{ fontFamily: "var(--font-display)" }}>
                {tpl(t.sections.ctaFinalTitle, { city: city.name }).split(city.name).reduce<React.ReactNode[]>((acc, part, i, arr) => {
                  acc.push(part);
                  if (i < arr.length - 1) acc.push(<span key={i} className="text-[#FF3B30]">{city.name}</span>);
                  return acc;
                }, [])}
              </h2>
