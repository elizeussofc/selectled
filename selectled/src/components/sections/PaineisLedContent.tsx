              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {pl.panelTypes.map((p, i) => (
                    ...
                    >
                      <td className="py-4 px-4 font-semibold text-[#FF0000]">{p.model}</td>
          ...
          <Container>
            ...
            <div className="grid grid-cols-4 md:grid-cols-8 gap-4">
              {pl.eventTypes.map((label, i) => {
                ...
                return (
                  <div key={label} className="flex flex-col items-center gap-2 p-4 bg-[#141414] border border-[#2C2C2E] rounded-xl hover:border-[rgba(255,0,0,0.3)] transition-colors cursor-default">
